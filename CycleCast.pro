...
UBUNTU_TRANSLATION_DOMAIN="cyclecast.ahoneybun"
...
aptest.commands = QML2_IMPORT_PATH=$$OUT_PWD/backend bash $$PWD/CycleCast/tests/autopilot/run
aptest.depends  = sub-CycleCast sub-backend-App

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/backend/tests/unit -import $$OUT_PWD/backend
unittest.commands += && /usr/bin/qmltestrunner -input $$PWD/CycleCast/tests/unit -import $$OUT_PWD/backend
unittest.depends  = sub-CycleCast sub-backend-App
